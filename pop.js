...
// sum female pop
const female = data.reduce(function(a, b){
  // first case has two objects
  if(typeof a == "object")
    return a["females"] + b["females"];
...
// sum male pop
const male = data.reduce(function(a, b){
  // first case has two objects
  if(typeof a == "object")
    return a["males"] + b["males"];

  // else just sum normally
  return a + b["males"];
});
...
console.log("female percentage: ", femaleP);
console.log("male percentage: ", maleP);
...
// assumes that the median is not in the first two
const median = parseInt(data. reduce(function(a, b){
  // first  case
  if(typeof a == "object")
  ...
  // else keep summing the population
  return a + b["total"];
}));
